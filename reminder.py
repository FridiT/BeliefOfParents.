...
class Reminder:
    ...
    def reminder(self, ga):
        ...
        want_title = ga.gender_first + " wants to sleep."
        want_text = ga.gender_first + "'s tired, " + ga.gender + " wants\
          \nto sleep, " + ga.belong + " body wants to sleep.\n" + ga.gender_first + " just wants to sleep."
        ...
        need_title = ga.gender_first + " needs to sleep."
        need_text = ga.name + " is tired, now it's " + ga.belong + " bedtime!"
        ...
        last_text = ga.gender_first + " sleeps!!"
        last2_text = "Finally!!"
